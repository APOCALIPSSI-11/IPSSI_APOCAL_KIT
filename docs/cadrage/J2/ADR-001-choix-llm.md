...
> **Date** : 30 juin 2026
> **Auteurs** : Seer MENSAH ASSIAKOLEY, Mohamed Amine EL AFRIT (PO)
> **Version** : 1.3
...
- Protocole de benchmark : [protocole-benchmark.md](./protocole-benchmark.md)
- Résultats benchmark : [benchmark-llm.md](./benchmark-llm.md)
- Justification opérationnelle de la bascule : [decision-bascule.md](./decision-bascule.md)
- Product Vision Board (contrainte souveraineté) : [docs/cadrage/J1/j1.md](../J1/j1.md)
