...
- `docs/pertubations/j2/Etude_benchmarks/measurements-latency.csv` (90 lignes : 6 modèles × 3 cours × 5 runs)
- `docs/pertubations/j2/Etude_benchmarks/measurements-quality.csv` (54 lignes : 6 modèles × 3 cours × 3 testeurs)
- Quiz générés (échantillons) : `docs/pertubations/j2/Etude_benchmarks/samples/`
...
### Documents projet
- ADR-0001 (décision) : [./ADR-001-choix-llm.md](../../../adr/ADR-001-choix-llm.md)
...
- Product Vision Board : [docs/cadrage/artefacts/equipe-11-product-vision-board-v1.1.docx](../../../cadrage/artefacts/equipe-11-product-vision-board-v1.1.docx)
