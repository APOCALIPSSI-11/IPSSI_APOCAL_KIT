...
> **Persona de référence** : [Alberta Aravindan](persona-alberta.md)
...
| **Persona** | Alberta Aravindan (élève internationale) |
...
**En tant qu'**Alberta, **je veux** basculer la langue de l'interface (FR/EN/ES) via un sélecteur, **afin de** comprendre l'application sans effort de traduction.
...
- **When** : Alberta choisit "Español" dans le sélecteur de langue
...
**En tant qu'**Alberta, **je veux** que le quiz généré à partir d'un cours corresponde à la langue de ce cours, **afin de** réviser sans changer de langue en cours de route.
...
- **When** : Alberta déclenche la génération d'un quiz sur ce cours
...
**En tant qu'**Alberta, **je veux** que les dates, scores et nombres affichés respectent les conventions de ma langue/région, **afin de** lire mes résultats sans ambiguïté.

`International · COULD · 2 SP`

- **Given** : la locale active de Alberta est `es-ES`
...
|----|------|---------|--------|----|----------------|
| US-I18N-01 | EP-14 | Alberta (international) | MUST | 8 | R-I18N-01 |
| US-I18N-02 | EP-14 | Alberta (international) | SHOULD | 5 | R-I18N-02 |
| US-I18N-03 | EP-14 | Alberta (international) | COULD | 2 | — |
